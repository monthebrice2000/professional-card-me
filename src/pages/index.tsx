      ...
      <div>
        <div className="mx-auto my-32 flex h-auto max-w-4xl flex-wrap items-center lg:my-0 lg:h-screen">
          ...
          >
            <div className="p-4 text-center md:p-12 lg:text-left">
              <div
                ...
                style={{
                  backgroundImage: `url('https://ik.imagekit.io/kjatsnf4j/toto_66YsOawVan?updatedAt=1684956849910')`,
                }}
              />
              ...
              <div className="mx-auto w-4/5 border-b-2 border-green-500 pt-3 opacity-25 lg:mx-0" />
              <p className="flex items-center justify-center pt-4 text-base font-bold lg:justify-start">
                ...
                Ingénieur DevSecOps / Ingénieur Logiciel
              </p>
              <p className="flex items-center justify-center pt-2 text-xs text-gray-600 lg:justify-start lg:text-sm">
                ...
                France, Grenoble - 45.1835° N, 5.7470° W
              </p>
              <p className="pt-8 text-sm">
                Passionné et doué par la conception et l&#39;automatisation, je
                recherche CDI sur un poste de DevOps/DevSecOps ou d&#39;Ingénieur
                logiciel dans l&#39;objectif d&#39;automatiser les processus de
                déploiement des applications, systèmes et réseaux avancés.
              </p>
              ...
              <div className="mx-auto mt-6 flex w-4/5 flex-wrap items-center justify-center pb-16 lg:w-full lg:pb-0">
                ...
                <a
                  className="link mr-2"
                  href="https://github.com/monthebrice2000"
              ...
              <a className="link" href="#" data-tippy-content="@youtube_handle"><svg className="h-6 fill-current text-gray-600 hover:text-green-700" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>YouTube</title><path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg></a> */}
                <a
                  className="link mr-2"
                  href="https://www.linkedin.com/in/brice-monthe-0b64061a2/"
                  data-tippy-content="@github_handle"
                  target="_blank"
                >
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="ionicon h-6 fill-current text-gray-600 hover:text-green-700"
                    viewBox="0 0 512 512"
                  >
          ...
          <div className="w-full lg:w-2/5">
            <img
              src="https://ik.imagekit.io/kjatsnf4j/hgduytd_3-xFo5XfT?updatedAt=1684886004417"
